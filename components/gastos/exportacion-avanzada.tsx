// Componente para opciones avanzadas de exportación
"use client"
...
interface OpcionesExportacion {
  ...
  incluirAprobados: boolean
  incluirPendientes: boolean
  rangoFechas: "todos" | "mes" | "trimestre" | "año"
}

export function ExportacionAvanzada() {
  const { exportarCSV, exportarExcel, exportarPDF, exportando } = useExportarGastos()
  const [dialogAbierto, setDialogAbierto] = useState(false)
  const [opciones, setOpciones] = useState<OpcionesExportacion>({
    formato: "pdf",
    incluirProyectos: true,
    incluirAprobados: true,
  ...
  return (<Dialog open={dialogAbierto} onOpenChange={setDialogAbierto}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <Label className="text-sm font-medium">Formato de archivo</Label>            <RadioGroup
            ...
            {opciones.formato === "excel" && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-3">
                ...
                <ul className="text-xs text-green-700 space-y-1">
                  <li>• 📊 Reporte detallado con todos los gastos</li>
                  <li>• 📈 Resumen por proyecto con estadísticas</li>
                  <li>• 📊 Análisis por categoría de gastos</li>
            ...
            {opciones.formato === "pdf" && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-3 mt-3">
                ...
                <ul className="text-xs text-red-700 space-y-1">
                  ...
                  <li>• 📄 Tabla detallada de gastos principales</li>
          ...
          {/* Estados a incluir */}
          <div className="space-y-3">
            <Label className="text-sm font-medium">Estados de gastos</Label>
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="aprobados"
                  checked={opciones.incluirAprobados}
                  onCheckedChange={(checked) => 
                    setOpciones(prev => ({ ...prev, incluirAprobados: !!checked }))}
                />
                <Label htmlFor="aprobados">Gastos aprobados</Label>
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="pendientes"
                ...
                />
                <Label htmlFor="pendientes">Gastos pendientes</Label>
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-end space-x-2 pt-4">
          ...
          >
            ...
            disabled={exportando || (!opciones.incluirAprobados && !opciones.incluirPendientes)}
            className={
              opciones.formato === "pdf" 
